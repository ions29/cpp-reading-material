...
A Lever is a Simple Machine made up of a rigid bar or plank, that is used to lift (or exert force on) an object, by pivoting (or rotating) on a fixed point, called a fulcrum. The end result (in simple terms) is that the longer the bar, the less force necessary to lift the object.<br>

![image](https://github.com/ions29/cpp-reading-material/assets/127531384/d8342ed7-cb99-433b-9ff5-ccc70596225f)

To learn more about drones, drone safety, and other Fun Facts... please also visit www.dronecadets.com!
